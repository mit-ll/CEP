...
int main(int argc, char *argv[])
{
  ...
  //
  long unsigned int mask = 0; // just back door testing
  //
  ...
  int srcOffset = 0x00;
  int destOffset = 0;
  // use object file for small instead of .elf
  errCnt += load_mainMemory((char *)"./riscv_wrapper.o", ddr3_base_adr,srcOffset, destOffset, backdoor_on, verify);
  #endif
