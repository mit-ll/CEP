...
#include "../../../software/riscv-tests/env/p/riscv_test.h"

//
// VM flags
//
#define INVERT_MASK     (1<<0)
#define GIGAPAGE_MASK   (1<<1)
#define WALK1_0_2LEVELS (1<<2)
#define WALK1_0_3LEVELS (1<<3)
...
#define MAX_TEST_PAGES 128 // this must be the period of the LFSR below
...
#define GIGAPAGE_SIZE  (512*MEGAPAGE_SIZE)
