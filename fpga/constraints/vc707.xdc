...
#UART
set_property PACKAGE_PIN AU36 [get_ports uart_stx_pad_o]
set_property IOSTANDARD LVCMOS18 [get_ports uart_stx_pad_o]
set_property PACKAGE_PIN AU33 [get_ports uart_srx_pad_i]
set_property IOSTANDARD LVCMOS18 [get_ports uart_srx_pad_i]
set_property PACKAGE_PIN AT32 [get_ports uart_cts_pad_i]
set_property IOSTANDARD LVCMOS18 [get_ports uart_cts_pad_i]
set_property PACKAGE_PIN AR34 [get_ports uart_rts_pad_o]
set_property IOSTANDARD LVCMOS18 [get_ports uart_rts_pad_o]
...
create_generated_clock -name core_clk -source [get_pins clkgen_inst/sys_clk_in_p] -divide_by 4 [get_nets core_clk]
