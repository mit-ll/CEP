...
const uint32_t AES_START = AES_BASE + 0;
const uint32_t AES_PT_BASE = AES_BASE + 1;
const uint32_t AES_KEY_BASE = AES_BASE + 5;
const uint32_t AES_DONE = AES_BASE + 9;
const uint32_t AES_CT_BASE = AES_BASE + 10;
