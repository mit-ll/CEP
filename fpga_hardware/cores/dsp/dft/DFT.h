...
// Offset of DFT data and control registers in device memory map
...
const uint32_t DFT_IN_DATA  = DFT_IN_ADDR  + BLOCK_BYTES;
const uint32_t DFT_OUT_ADDR = DFT_IN_DATA  + BLOCK_BYTES + BLOCK_BYTES;
const uint32_t DFT_OUT_DATA = DFT_OUT_ADDR + BLOCK_BYTES;
const uint32_t DFT_DONE     = DFT_OUT_DATA + BLOCK_BYTES + BLOCK_BYTES;
