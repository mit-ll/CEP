...
// Offset of IIR data and control registers in device memory map
...
const uint32_t IIR_IN_DATA  = IIR_IN_ADDR  + BLOCK_BYTES;
const uint32_t IIR_OUT_ADDR = IIR_IN_DATA  + BLOCK_BYTES;
const uint32_t IIR_OUT_DATA = IIR_OUT_ADDR + BLOCK_BYTES;
const uint32_t IIR_DONE     = IIR_OUT_DATA + BLOCK_BYTES;
