...
vlog ${CEP_INCLUDES} ${CEP_DEFINES} ${CORES_ROOT}/dsp/dft/dft_top_wb.v
...
vlog ${CEP_INCLUDES} ${CEP_DEFINES} ${CORES_ROOT}/dsp/dft/dft_top_axi4lite.v

# Compile the testbench
vlog -sv ${CEP_INCLUDES} ${CEP_DEFINES} ${TB_ROOT}/tb_support.sv
vlog -sv ${CEP_INCLUDES} ${CEP_DEFINES} ${TB_ROOT}/tb_axi4lite_dft.sv
...
vopt +acc work.tb_axi4lite_dft -o dbugver
