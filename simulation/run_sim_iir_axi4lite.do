...
#//
#// File Name:      run_sim_iir_axi4lite.do 
#// Program:        Common Evaluation Platform (CEP)
#// Description:    TCL script to build/execute the CEP testbench
#// Notes:          This testbench will specifically target the IIR core
...
vlog ${CEP_INCLUDES} ${CEP_DEFINES} ${GENERATED_DSP_ROOT}/IIR_filter.v
vlog ${CEP_INCLUDES} ${CEP_DEFINES} ${CORES_ROOT}/dsp/iir/iir_top_wb.v
...
vlog  ${CEP_INCLUDES} ${CEP_DEFINES} ${CORES_ROOT}/dsp/iir/iir_top_axi4lite.v

# Compile the testbench
vlog -sv ${CEP_INCLUDES} ${CEP_DEFINES} ${TB_ROOT}/tb_support.sv
vlog -sv ${CEP_INCLUDES} ${CEP_DEFINES} ${TB_ROOT}/tb_axi4lite_iir.sv
...
vopt +acc work.tb_axi4lite_iir -o dbugver
