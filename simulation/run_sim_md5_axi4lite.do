...
#//
#// File Name:      run_sim_md5_axi4lite.do 
#// Program:        Common Evaluation Platform (CEP)
#// Description:    TCL script to build/execute the CEP testbench
#// Notes:          This testbench will specifically target the MD5 core
...
vlog ${CEP_INCLUDES} ${CEP_DEFINES} ${CORES_ROOT}/md5/md5_top_wb.v
...
vlog ${CEP_INCLUDES} ${CEP_DEFINES} ${CORES_ROOT}/md5/md5_top_axi4lite.v

# Compile the testbench
vlog -sv ${CEP_INCLUDES} ${CEP_DEFINES} ${TB_ROOT}/tb_support.sv
vlog -sv ${CEP_INCLUDES} ${CEP_DEFINES} ${TB_ROOT}/tb_axi4lite_md5.sv
...
vopt +acc work.tb_axi4lite_md5 -o dbugver
